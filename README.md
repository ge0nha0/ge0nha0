...
|:---:|:---:|:---:|:---:|
|[교내] 학부연구생|3D Human Model을 활용한 테니스 스윙 유사도 측정|CV/3D|<a href="https://github.com/ge0nha0/BEDLAM_Plus">Link</a>|
|[교내 학회] X:AI|EfficientViT를 활용한 경량화에 대한 성능 비교|CV/Video|<a href="https://github.com/ge0nha0/ETViT">Link</a>|
|[교내 학회] D&A|소설 속 인물의 속성과 감정을 반영한 사용자 맞춤형 TTS 오디오북|Speech|<a href="https://github.com/ge0nha0/KoBark">Link</a>|
|[전공] 산업AI: 캡스톤디자인|의료 특화 언어 모델을 사용한 입원 기간 예측|NLP/Time Series|업로드 예정|
